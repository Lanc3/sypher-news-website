    ...
    <main className="flex-1 py-12 sm:py-16">
      <SiteContainer max="sm">
        <div className="panel px-5 py-8 sm:px-8 sm:py-10">
          <h1 className="font-mono text-xl font-bold text-[#00ff41] sm:text-2xl">Unsubscribe</h1>
          ...
          <Link
            href="/"
            className="mt-8 inline-flex min-h-11 items-center font-mono text-sm text-[#ff2bd6] underline decoration-[#ff2bd6]/50 underline-offset-4 hover:decoration-[#ff2bd6]"
          >
            ← Return home
          </Link>
        </div>
