...
export function HeaderAdSlot() {
  ...
  return (
    <div className="flex min-h-[50px] w-full items-center justify-center gap-2 border-b border-[#00e8ff]/20 bg-black/40 px-3 py-2 text-xs text-[#666]">
      <span className="shrink-0 font-mono text-[#00e8ff]/70">[ AD_SLOT header ]</span>
...
export function SidebarAdSlot() {
  ...
  return (
    <aside className="w-full shrink-0 border-t border-[#00e8ff]/15 bg-black/30 p-3 sm:p-4 lg:mt-0 lg:w-[280px] lg:border-l lg:border-t-0">
      <div className="flex min-h-[100px] flex-col items-center justify-center gap-2 border border-dashed border-[#00e8ff]/25 p-3 text-center text-xs text-[#666] sm:min-h-[140px] lg:min-h-[600px] lg:items-start lg:justify-start lg:p-4">
        <span className="font-mono text-[#00e8ff]/70">[ AD_SLOT sidebar ]</span>
        {p.adUnitPath ? (
...
export function InArticleAdSlot() {
  ...
  if (!p) return null;
  return (
    <div className="my-8 flex min-h-[100px] flex-col items-center justify-center gap-2 border border-[#00e8ff]/20 bg-black/40 p-4 text-xs text-[#666] sm:min-h-[120px] sm:flex-row">
      <span className="shrink-0 font-mono text-[#00e8ff]/70">[ AD_SLOT in_article ]</span>
